...
export default function AuthCTAButton({
  ...
  return (
    ...
    >
      ...
      <svg className="ml-1.5" aria-hidden="true" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
