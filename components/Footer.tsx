              ...
              <ul className="space-y-2">
                {section.links.map(link => (
                  <li key={link.label}>
                    <Link
                      href={link.href}
                      className="inline-block py-2 text-[12px] text-[#5f6368] transition-colors hover:text-[#1d1d1f] md:py-0"
        ...
        <div className="mt-10 pt-6 border-t border-[#d2d2d7]">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              <a href="https://github.com/AntonyML" target="_blank" rel="noopener noreferrer" className="text-[#5f6368] hover:text-[#1d1d1f] transition-colors" aria-label="GitHub">
              ...
              <a href="https://www.linkedin.com/in/antony-monge-lopez/" target="_blank" rel="noopener noreferrer" className="text-[#5f6368] hover:text-[#1d1d1f] transition-colors" aria-label="LinkedIn">
              ...
              <a href="https://x.com/TonyML_" target="_blank" rel="noopener noreferrer" className="text-[#5f6368] hover:text-[#1d1d1f] transition-colors" aria-label="Twitter">
