        ...
        <div className="mt-10 pt-6 border-t border-[#d2d2d7]">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              <a href="https://github.com/AntonyML" className="text-[#858585] hover:text-[#1d1d1f] transition-colors" aria-label="GitHub">
              ...
              <a href="https://x.com/TonyML_" className="text-[#858585] hover:text-[#1d1d1f] transition-colors" aria-label="Twitter">
