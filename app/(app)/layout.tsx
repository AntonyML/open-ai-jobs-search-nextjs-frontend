...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return <div className="min-h-screen md:flex"><StepSidebar currentStep={step} completedSteps={done} /><main className="min-w-0 flex-1 px-5 py-8 md:px-12 md:py-14">{children}</main><LLMControlCenter /></div>
}
